...
**0:10 Start the evaluation early** (15 s)

Click `Evaluation`, click `Run all questions`. Let two or three rows fill in.

> I will come back to this. It is the labelled test set, 47 questions, grading itself live:
> the response type has to be right and the cited sections have to be the expected ones.
