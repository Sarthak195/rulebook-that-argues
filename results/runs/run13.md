...
Models that answered: `mistral/ministral-14b-2512`, `mistral/ministral-8b-2512`, `mistral/open-mistral-nemo`; chain head `mistral/ministral-8b-2512`; spread=on; 4 workers; wall time 43s. Embeddings `BAAI/bge-small-en-v1.5`, top_k=6, similarity gate=0.45.
...
Median latency 2751 ms, p90 4944 ms.
...
- answer: The rulebook does not address this situation. The closest clause covers a related case: You may be permitted a break of study for **one semester or one academic year** on medical grounds, certified by the Institute Medical Officer and approved by the Dean. This break cannot be granted more than once during your programme.

### A17: Can I get a mess rebate if I go home for two weeks?

- expected `answered`, got `not_covered` (status not_covered != answered)
- retrieved: HH §4.3, HH §4.1, HH §4.2, HH §7.2, AR §3.4, FS §4.2
- answer: The rulebook does not specify whether a mess rebate applies for an absence of two weeks. The only relevant passage addresses rebates for absences of seven days or more.
...
|---|---|---|---|---|
| B01 | Can I use a scientific calculator in the examination hall? | not_covered |  | The rulebook does not specify whether scientific calculators are permitted in the examination hall. The closest passage only lists permitted items like pens, pencils, and a water bottle, without mentioning calculators. |
| B02 | Will I get my hall ticket if my hostel fee is unpaid but my tuition fee is paid? | not_covered |  | The rulebook does not address this situation. The closest clause covers a related case: Your hall ticket will not be issued if your **tuition fee** is unpaid, even if your hostel fee is unpaid. The rules explicitly state that hall tickets are withheld only for outstanding tuition fee dues, not hostel fees. You must clear your tuition dues to receive your hall ticket. |
