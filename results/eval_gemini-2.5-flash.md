...
Model `google/gemini-2.5-flash` via OpenRouter, embeddings `BAAI/bge-small-en-v1.5`, top_k=6, similarity gate=0.45.
...
Median latency 1730 ms, p90 2167 ms.
...
| N18 | not_covered | answered | NO | status answered != not_covered |
...
### N18: Will I get my hall ticket if my hostel fee is unpaid but my tuition fee is paid?

- expected `not_covered`, got `answered` (status answered != not_covered)
- retrieved: AR §12.2, EE §1.2, FS §2.1, SF §5.1, FS §2.2, SF §5.2
- answer: You will receive your hall ticket even if your hostel fee is unpaid, provided you have no outstanding tuition fee dues, have satisfied the attendance requirement, and have registered for the course. The regulations state that hall tickets are withheld for outstanding tuition fees, but not for outstanding hostel fees.
